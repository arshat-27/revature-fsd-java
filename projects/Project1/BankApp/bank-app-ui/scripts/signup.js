...
let password = document.getElementById("psi");
...
async function addCustomer() {
    let employee = {
        ...
        password: form.psi.value,
        phoneno: form.pn.value,
    };
...
password.addEventListener("keyup", function () {
    ...
    if (password.value != "") {
        ...
        if (!password.value.match(pw)) {
            let pass = document.getElementById("passwordValidation");
            pass.innerText = "Password cannot exceed [7-15]character and use special character and numbers ";
            valid = false;
            console.log(valid);
        }
...
signup.addEventListener("click", function () {
    if (valid == true){
        ...
        d.innerText = "Added Successfully";
    }
    else{
        let d = document.getElementById("display");
        d.innerText = "Please Fill All The Fields";
